      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button href={config.brand.ctaUrl} target="_blank">{config.brand.ctaLabel}</Button>
          </div>

          <button className="md:hidden p-2 text-dark" onClick={() => setMobileOpen(!mobileOpen)} aria-label={mobileOpen ? 'Close menu' : 'Open menu'}>
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            <Button href={config.brand.ctaUrl} target="_blank" fullWidth onClick={() => setMobileOpen(false)}>
