...
export default function TemplateHowItWorks() {
  ...
  return (
    <section id="process" className="bg-[#F7FFFE] py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        {/* Heading */}
        <motion.h2
          className="font-display font-normal text-[clamp(28px,4vw,52px)] text-dark leading-tight uppercase text-center mb-16"
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <div className="relative z-10 w-[52px] h-[52px] rounded-full border-2 border-teal-light bg-white flex items-center justify-center mb-5 shadow-[0_4px_16px_rgba(45,212,192,0.15)]">
                <span className="font-display font-normal text-xl text-olive">
                  {String(step.step).padStart(2, '0')}
                </span>
              </div>

              <h3 className="font-display font-normal text-lg text-dark uppercase mb-2">
                {step.title}
              </h3>
