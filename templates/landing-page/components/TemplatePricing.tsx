            ...
            >
              ...
              {tier.highlighted && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="bg-lime text-olive text-[11px] font-normal uppercase tracking-[0.12em] px-4 py-1.5 rounded-full whitespace-nowrap">
                    Most Popular
                  </span>
                </div>
              )}
              ...
              {/* Tier name & price */}
              <div className="mb-6">
                <h3 className="font-display font-normal text-[18px] text-dark uppercase tracking-wide mb-2">
                  {tier.name}
                </h3>
                <div className="flex items-baseline gap-1">
                  <span className="font-display font-normal text-5xl text-dark">
              ...
              {/* CTA */}
              <LandingButton href={config.brand.ctaUrl} target="_blank" fullWidth>
                {tier.cta}
              </LandingButton>
            </motion.div>
          ))}
