  ...
  return (
    <section id="testimonials" className="bg-teal-light py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        {/* Heading */}
        <motion.h2
          className="font-display font-normal text-[clamp(28px,4vw,52px)] text-dark leading-tight uppercase text-center mb-6"
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full ring-2 ring-teal-mid/40 bg-teal-light flex items-center justify-center">
                  <span className="font-display font-normal text-sm text-teal-accent">
                    {testimonial.initials}
                  </span>
                </div>
                <div>
                  <p className="font-body font-normal text-dark text-sm">{testimonial.name}</p>
                  <p className="font-body text-teal-accent text-xs font-normal">
