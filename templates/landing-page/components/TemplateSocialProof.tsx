...
export default function TemplateSocialProof() {
      ...
      <div className="flex items-center justify-center">
        ...
        >
          {items.map((item, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-6 px-6 font-display font-normal text-white uppercase tracking-widest text-sm"
            >
              {item}
