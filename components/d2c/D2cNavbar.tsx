...
export default function D2cNavbar() {
            ...
            <nav className="relative flex-1 flex flex-col justify-center px-6 gap-1">
              {D2C_NAV_LINKS.map((link, i) => (
                <motion.a
                  ...
                  style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                  <span className="font-display font-black text-[28px] uppercase text-white group-hover:text-teal-strong transition-colors duration-200">
                    {link.label}
                  </span>
                  <ArrowRight className="w-4 h-4 text-white/20 group-hover:text-teal-strong group-hover:translate-x-1 transition-all duration-200" />
                </motion.a>
              ))}
            </nav>
