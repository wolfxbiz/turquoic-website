    ...
    <section className="bg-white py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <span className="text-teal-accent">What You Need Is a Team to Build It.</span>
        </motion.h2>
        ...
        {/* Closing line */}
        <motion.p
          className="text-center font-display font-bold text-lg text-teal-accent uppercase tracking-wide"
          initial={{ opacity: 0 }}
          animate={isInView ? { opacity: 1 } : undefined}
          transition={{ delay: 0.6, duration: 0.7 }}
        >
          At Turquoic, we eliminate the guesswork.
        </motion.p>
      </div>
    </section>
  )
